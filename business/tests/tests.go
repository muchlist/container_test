...
import (
	...
	"github.com/muchlist/container_test/business/dbschema"
	"github.com/muchlist/container_test/pkg/auth"
	"github.com/muchlist/container_test/pkg/database"
	"github.com/muchlist/container_test/pkg/docker"
	"github.com/muchlist/container_test/pkg/keystore"
	"github.com/muchlist/container_test/pkg/logger"
	"go.uber.org/zap"
)
...
func (test *Test) Token(email, pass string) string {
	...
	store := userrepo.NewStore(test.Log, test.DB)
